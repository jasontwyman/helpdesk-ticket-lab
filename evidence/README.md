...
|---|---|---|---|---|---|---|---|
| 01 | [AD environment users](screenshots/01-ad-environment-users.png) | `e0f5f647e721ab9d2300a962c1e4ab3fd3ed933085918b37e5027aa9b9691159` | 1024×768 | Config | A PowerShell query visibly lists synthetic AD users with selected account fields. | No visible redaction; provenance/edit history unverified. No credential value is visible. | Residual password-confirmation prompt text from an earlier command is visible above the query; it exposes no value and does not prove credential state. The user list does not prove creation steps, sign-in, or effective access. |
...
| 06 | [Lockout source Event 4740](screenshots/06-lockout-source-event-4740.png) | `d9c5ae6dc205f3a24776a39fc22bf895419d44310ae4563b74a06a9e184ca2b2` | 1024×768 | Executed | A positional projection of one Security Event 4740 visibly labels the locked account and `DC01` as caller. | No visible redaction; provenance/edit history unverified. | The captured command uses `Properties[0]`/`Properties[1]`, not named XML fields. It is not raw EVTX, does not provide robust parser provenance, and does not establish why the attempts occurred. |
...
| 14 | [osTicket ticket queue](screenshots/14-osticket-ticket-queue.jpg) | `fe24644e74635cd83bf5c2a680914b0c889df56cac73d43e4599e0c0d7bb4baf` | 1568×745 | Illustrative | The **Open** view visibly contains seven synthetic case-study records with blank assignees, plus the default `osTicket Installed!` record. | No visible redaction; provenance/edit history unverified. | Seeded records do not prove investigation, assignment, escalation, resolution, closure, or SLA performance. Thread-count icons do not identify message authors, recipients, or content. |
| 15 | [osTicket ticket detail](screenshots/15-osticket-ticket-detail.jpg) | `65274f20fce31ac847a351a944fc496496c96be874447a8b2865a38f6870c34e` | 1568×745 | Illustrative | A synthetic account-lockout ticket is visibly **Open** and **Unassigned** with seeded user text. | No visible redaction; provenance/edit history unverified. | A `Last Response` timestamp and thread count are visible, but no response content or author is shown. The capture does not prove that the Markdown communication template was sent, nor does it show an AD action, assignment, status transition, or resolution. |
...
| 18 | [AD remediation cleanup](screenshots/18-ad-remediation-cleanup.png) | `b4715d58752545331a230506d8344761dea5e2364116f818d9ad9961e788e90f` | 970×440 | Executed | The capture shows a reset command invoked with an undisclosed variable and no visible error, then queries showing `kross` disabled and `nalvarez` absent from the listed post-cleanup groups. | No visible redaction; provenance/edit history unverified. The replacement value is not visible. | It does not independently verify the new credential value or generation method, secure handoff, complete historical state, approval, or effective resource access. |
